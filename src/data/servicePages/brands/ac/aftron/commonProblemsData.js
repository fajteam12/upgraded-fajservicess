const commonProblemsData = {
  eyebrow: "Common Aftron AC Issues",
  title: "Common Aftron AC Problems That May Require Maintenance",
  items: [
    {
      title: "Weak Airflow",
      description: {
        parts: [
          ...
          " from your vents, it may indicate an issue with your Daikin AC system, such as a clogged filter or a malfunctioning fan.",
        ],
      },
    },
    {
    ...
    },
    {
      title: "Leaking Water",
      description:
        "Water pooling around the Aftron AC or dripping from the vents may indicate a blocked drain or frozen coils.",
    },
    {
