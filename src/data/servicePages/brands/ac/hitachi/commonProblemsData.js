const commonProblemsData = {
  eyebrow: "Common Hitachi AC Issues",
  title: "Common Hitachi  AC Problems That May Require Maintenance",
  items: [
    {
      title: "Weak Airflow",
      description: {
        parts: [
          ...
          " from a Hitachi air conditioner may indicate a clogged filter or faulty fan, which should be fixed for efficient cooling.",
        ],
      },
    },
    {
