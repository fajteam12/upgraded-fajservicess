const commonProblemsData = {
  eyebrow: "Common Samsung AC Issues",
  title: "Common Samsung AC Problems That May Require Maintenance",
  items: [
    {
      title: "Weak Airflow",
      description: {
        parts: [
          ...
          " from Samsung AC vents may indicate a problem, such as a clogged filter or a faulty fan, which should be addressed to ensure efficient cooling.",
        ],
      },
    },
    {
