const commonProblemsData = {
  eyebrow: "Common Crafft AC Issues",
  title: "Common Crafft AC Problems That May Require Maintenance",
  items: [
    {
      title: "Weak Airflow",
      description: {
        parts: [
          ...
          " from Crafft AC vents may indicate a problem, such as a clogged filter or a faulty fan, which should be addressed to ensure efficient cooling.",
        ],
      },
    },
    {
