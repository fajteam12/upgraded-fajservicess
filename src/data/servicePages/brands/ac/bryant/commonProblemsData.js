const commonProblemsData = {
  eyebrow: "Common Bryant AC Issues",
  title: "Common Bryant AC Problems That May Require Maintenance",
  items: [
    {
      title: "Weak Airflow",
      description: {
        parts: [
          ...
          " from Bryant AC ducts may signal a blocked filter or faulty motor. Timely action is essential for efficient cooling and system longevity.",
        ],
      },
    },
    {
