const commonProblemsData = {
  eyebrow: "Common Whirlpool AC Issues",
  title: "Common Whirlpool  AC Problems That May Require Maintenance",
  items: [
    {
      title: "Weak Airflow",
      description: {
        parts: [
          ...
          " from a Whirlpool air conditioner may indicate a clogged filter or faulty fan, which should be fixed for efficient cooling.",
        ],
      },
    },
    {
