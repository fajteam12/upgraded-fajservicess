const commonProblemsData = {
  eyebrow: "Common TCL AC Issues",
  title: "Common TCL AC Problems That May Require Maintenance",
  items: [
    {
      title: "Weak Airflow",
      description: {
        parts: [
          ...
          " from a TCL air conditioner may indicate a clogged filter or faulty fan, which should be fixed for efficient cooling.",
        ],
      },
    },
    {
