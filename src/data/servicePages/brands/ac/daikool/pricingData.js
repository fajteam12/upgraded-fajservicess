const pricingData = {
  ...
  items: [
    ...
    {
      title: "Basic AC Cleaning Service",
      ...
      popup: {
        ...
        sections: [
          ...
          },
          {
            label: "Terms & Conditions",
            text:
              "Starting from AED 290 basic cleaning service charge applies based on the type, capacity of the unit, and location for each diagnosis.",
          },
        ],
      },
    },
