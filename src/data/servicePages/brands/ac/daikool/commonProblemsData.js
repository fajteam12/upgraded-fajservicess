const commonProblemsData = {
  eyebrow: "Common Daikool AC Issues",
  title: "Common Daikool AC Problems That May Require Maintenance",
  items: [
    {
      title: "Weak Airflow",
      description: {
        parts: [
          "If you notice a decline in airflow from your vents, it may indicate a problem with your Daikool AC system, such as a ",
          {
            text: "blocked filter",
