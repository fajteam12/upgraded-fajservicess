const commonProblemsData = {
  eyebrow: "Common White Westinghouse AC Issues",
  title:
    "Common White Westinghouse AC Problems That May Require Maintenance",
  items: [
    {
      title: "Weak Airflow",
      description: {
        parts: [
          ...
          " from a White Westinghouse air conditioner may indicate a clogged filter or faulty fan, which should be fixed for efficient cooling.",
        ],
      },
    },
    {
