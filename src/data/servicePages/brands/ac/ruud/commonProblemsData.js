const commonProblemsData = {
  eyebrow: "Common Ruud AC Issues",
  title: "Common Ruud AC Problems That May Require Maintenance",
  items: [
    {
      title: "Weak Airflow",
      description: {
        parts: [
          ...
          " from Ruud AC ducts may signal a blocked filter or faulty motor. Addressing these issues ensures efficient cooling and longer system life.",
        ],
      },
    },
    {
