const commonProblemsData = {
  eyebrow: "Common Midea AC Issues",
  title: "Common Midea AC Problems That May Require Maintenance",
  items: [
    {
      title: "Weak Airflow",
      description: {
        parts: [
          "If you notice a decline in airflow from your vents, it may indicate a problem with your Midea AC system, such as a ",
          {
            text: "blocked filter",
