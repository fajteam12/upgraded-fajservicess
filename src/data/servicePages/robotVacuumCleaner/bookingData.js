const bookingData = {
  ...
  title: "Request Vacuum Cleaner Service",
  description:
  ...
  defaultService: "Robot Vacuum Cleaner Repair",
  ...
  modal: {
    ...
    description:
      "Enter your details and continue through WhatsApp to request vacuum-cleaner inspection, repair, servicing or maintenance coverage.",
    submitLabel: "Continue with booking request",
    closeLabel: "Close booking dialog",
  },
  messageGreeting:
    "Hello FAJ Technical Services, I would like to book vacuum-cleaner service:",
  messageLabels: {
    name: "Name",
    phone: "Phone",
    location: "Location",
