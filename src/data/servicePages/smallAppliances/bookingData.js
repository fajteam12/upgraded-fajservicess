const bookingData = {
  ...
  title: "Request Small Appliance Service",
  description:
  ...
  defaultService: "Small Appliance Repair and Maintenance",
  ...
  modal: {
    ...
    description:
      "Enter your details and continue through WhatsApp to request small-appliance inspection, repair or maintenance coverage.",
    submitLabel: "Continue with booking request",
    closeLabel: "Close booking dialog",
  },
  messageGreeting:
    "Hello FAJ Technical Services, I would like to book small-appliance service:",
  messageLabels: {
    name: "Name",
    phone: "Phone",
    location: "Location",
