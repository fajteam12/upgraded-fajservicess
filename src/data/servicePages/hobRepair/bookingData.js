const bookingData = {
  ...
  title: "Book a Hob Service Appointment",
  description:
  ...
  defaultService: "Hob Repair General Diagnostics",
  ...
  modal: {
    eyebrow: "Request hob service",
    description:
      "Enter your details and continue through WhatsApp to request hob inspection, cleaning, installation or repair.",
    submitLabel: "Continue with booking request",
    closeLabel: "Close booking dialog",
  },
  messageGreeting:
    "Hello FAJ Technical Services, I would like to request hob service:",
  messageLabels: {
    name: "Name",
    phone: "Phone",
    location: "Location",
