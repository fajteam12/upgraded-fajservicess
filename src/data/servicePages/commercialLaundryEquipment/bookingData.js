const bookingData = {
  ...
  title: "Book Your Commercial Laundry Equipment Service",
  description:
  ...
  defaultService: "Commercial Laundry Equipment Maintenance",
  locations: ["Dubai", "Sharjah", "Abu Dhabi"],
  fields: {
    name: { label: "Company / full name", placeholder: "e.g. City Laundry / John Doe" },
  ...
  modal: {
    ...
    description:
      "Enter your details and continue through WhatsApp to confirm your commercial laundry appointment.",
    submitLabel: "Continue with booking request",
