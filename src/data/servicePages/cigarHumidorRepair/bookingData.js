const bookingData = {
  ...
  title: "Request Cigar Humidor Service",
  description:
  ...
  defaultService: "Cigar Humidor Repair and Maintenance",
  ...
  modal: {
    ...
    description:
      "Enter your details and continue through WhatsApp to request cigar-humidor inspection, repair or maintenance coverage.",
    submitLabel: "Continue with booking request",
    closeLabel: "Close booking dialog",
  },
  messageGreeting:
    "Hello FAJ Technical Services, I would like to book cigar-humidor service:",
  messageLabels: {
    name: "Name",
    phone: "Phone",
    location: "Location",
