						...
						return (
							...
							>
								<article className="core-principles__card">
									<div className="core-principles__card-top">
										<span className="core-principles__icon" aria-hidden="true">
											<PrincipleIcon name={principle.icon} />
										</span>

										{principle.year && (
											<span className="core-principles__year">
												{principle.year}
											</span>
										)}
									</div>
								...
								<span className="core-principles__marker" aria-hidden="true">
									{principle.number}
								</span>
							</ScrollSlide>
						);
