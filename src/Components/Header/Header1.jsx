      ...
      <div className="faj-header__services-grid">
        {services.map((service) => (
          ...
          >
            ...
            {service.description && (
              <p className="faj-header__service-description">{service.description}</p>
            )}
...
function DesktopNavigation({ pathname, services, aboutItems }) {
  ...
  const aboutActive = aboutItems.some((item) => pathIsActive(pathname, item.path));
  ...
  return (
    <nav className="faj-header__desktop-nav" aria-label="Primary navigation">
      <div className="faj-header__nav-pill">
        ...
        <span className="faj-header__logo-space" aria-hidden="true" />
...
function MobileServiceGroup({ service, closeMenu }) {
  if (!service.children?.length) {
    return (
      <HeaderLink to={service.path} className="faj-header__mobile-service-link" onClick={closeMenu}>
        <span>
  ...
  return (
    <div className="faj-header__mobile-overlay">
      ...
      <nav className="faj-header__mobile-panel" aria-label="Mobile navigation">
        <HeaderLink to="/" className="faj-header__mobile-primary-link" onClick={closeMenu}>
          Home
        </HeaderLink>
        ...
        <details className="faj-header__mobile-group">
          ...
          <div className="faj-header__mobile-group-content">
            <HeaderLink to="/services/" className="faj-header__mobile-view-all" onClick={closeMenu}>
              View all services
              <ArrowIcon />
            </HeaderLink>
            {services.map((service) => (
              <MobileServiceGroup key={service.label} service={service} closeMenu={closeMenu} />
            ))}
          </div>
        </details>
        ...
        <HeaderLink to="/blogs/" className="faj-header__mobile-primary-link" onClick={closeMenu}>
          Blog
        </HeaderLink>
        <HeaderLink to="/contact-us/" className="faj-header__mobile-primary-link" onClick={closeMenu}>
          Get In Touch
        </HeaderLink>

        <HeaderLink to="/contact-us/" className="faj-header__mobile-cta" onClick={closeMenu}>
          Book a Service
          <ArrowIcon />
        </HeaderLink>
