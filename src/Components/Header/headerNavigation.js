export const servicesNavigation = [
  {
    ...
    children: [
      ...
      {
        label: "AMC (Maintenance Contract)",
  ...
  },
  {
    ...
    children: [
      ...
      {
        label: "Commercial Coffee Machine Repair",
